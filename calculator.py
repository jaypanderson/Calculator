...
class SimpleCalc:
    ...
    def \
        ...
        button_multiply = ctk.CTkButton(root, text='⨉', width=self.width, height=self.height, border_width=self.border,
                                        font=self.button_font, command=lambda: arithmatic('x'))
